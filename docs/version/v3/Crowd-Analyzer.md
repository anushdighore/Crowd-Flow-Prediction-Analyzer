# Crowd Analyzer v3 - User Guide

## Table of Contents
- [Getting Started](#getting-started)
- [Interface Overview](#interface-overview)
- [Loading and Processing Videos](#loading-and-processing-videos)
...
### Load a Video
- Click on "Load Video" and select your video file
- Supported formats: MP4, AVI, MOV, etc.

### Configure Settings
- Click on "Settings" to adjust parameters
- Select appropriate YOLO model based on your needs (speed vs. accuracy)
- Set output folder for saving results
...
### Common Issues
- **Poor Tracking Accuracy**: Try adjusting the confidence threshold or using a different YOLO model
- **Slow Performance**: Reduce the frame step or use a smaller YOLO model
- **Calibration Errors**: Ensure accurate point selection and distance measurements

### Getting Help
- Check the [Troubleshooting Guide](TROUBLESHOOTING.md)
- Open an issue on our [GitHub repository](https://github.com/your-repo)
